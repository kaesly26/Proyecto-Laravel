        ...
        <ul class="list">
            ...
            <li class="list__item">
                <div class="list__button">
                    ...
                    <a href="<?php echo e(asset('/')); ?>" class="nav__link">Inicio</a>
                </div>
            </li>
            ...
            <li class="list__item list__item--click">
                ...
                <ul class="list__show">
                    <li class="list__inside">
                        <a href="<?php echo e(route('categoria')); ?>" class="nav__link nav__link--inside">Categorias</a>
                    </li>

                    <li class="list__inside">
                        <a href="<?php echo e(route('crearProducto')); ?>" class="nav__link nav__link--inside">Crear Producto</a>
                    </li>
                </ul>
            ...
            <li class="list__item">
                <div class="list__button">
                    ...
                    <a href="<?php echo e(route('admin.ingresar')); ?>" class="nav__link">Clientes</a>
                </div>
            </li>
