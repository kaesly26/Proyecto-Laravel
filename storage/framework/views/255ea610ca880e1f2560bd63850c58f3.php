...
<header>
    <div class="container">
        <img src="<?php echo e(asset('img/Russo.png')); ?>" alt="" height="200px" width="240px">
    </div>
        ...
        <ul class="list">
            ...
            <li class="list__item list__item--click">
                ...
                <ul class="list__show">
                    ...
                    <li class="list__inside">
                        <a href="<?php echo e(route('pedidos.create')); ?>" class="nav__link nav__link--inside">Entrada de pedidos</a>
                    </li>
                </ul>
